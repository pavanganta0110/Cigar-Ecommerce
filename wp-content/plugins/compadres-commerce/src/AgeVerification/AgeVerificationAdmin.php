		...
		<div class="wrap"><h1><?php esc_html_e( 'Checkout Age Verification', 'compadres-commerce' ); ?></h1>
			...
			<form action="options.php" method="post">
				...
				<table class="form-table" role="presentation">
					...
					<tr><th scope="row"><label for="compadres-age-provider"><?php esc_html_e( 'Provider', 'compadres-commerce' ); ?></label></th><td><select id="compadres-age-provider" name="<?php echo esc_attr( WordPressAgeVerificationRuntime::OPTION ); ?>[provider]"><option value=""><?php esc_html_e( 'Not configured', 'compadres-commerce' ); ?></option><option value="agechecker" <?php selected( $settings['provider'], 'agechecker' ); ?>>AgeChecker</option><option value="self_attestation" <?php selected( $settings['provider'], 'self_attestation' ); ?>><?php esc_html_e( 'Self-attestation checkbox (no identity verification)', 'compadres-commerce' ); ?></option><option value="mock" <?php selected( $settings['provider'], 'mock' ); ?>><?php esc_html_e( 'Development mock', 'compadres-commerce' ); ?></option></select><p class="description"><?php esc_html_e( 'Self-attestation is a materially weaker compliance posture than a verification provider: it accepts a single checkbox with no identity or date-of-birth check. Confirm this is acceptable for your jurisdictions before selecting it.', 'compadres-commerce' ); ?></p></td></tr>
